        ...
        <div className="mt-10 grid md:grid-cols-2 gap-8">
          ...
          <Card>
            ...
            <div className="mt-8 flex gap-4 flex-wrap">
              <GlowButton href="/pro">Unlock PRO (19€)</GlowButton>
              <GlowButton
            ...
            <div className="mt-3 text-xs opacity-70">
              PRO shows <span className="font-bold">where you statistically blow it</span> (daily loss + drawdown paths) and generates a survival plan.
            </div>
